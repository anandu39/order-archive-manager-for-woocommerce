...
class RestoreHandler {
    ...
    */
    ...
    public function get_total_archived_orders( array $statuses = [] ): int {
    ...
    */
    ...
    public function get_batch_archived_order_ids( array $statuses = [] ): array {
        ...
        if ( empty( $statuses ) ) {
            ...
            $sql = $this->wpdb->prepare(
                ...
                array_merge( $statuses, [ $this->batch_size ] )
            );
        }
    ...
    */
    ...
    public function process_restore_batch( array $statuses = [], bool $dry_run = false ): array {
