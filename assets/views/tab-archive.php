    ...
    <div class="woam-step woam-step--active" data-step="1">
        ...
        <div class="woam-field-group">
            ...
            <div class="woam-presets">
                <button type="button" class="woam-presets" data-month="6"><?php esc_html_e( '6 months ago', 'woo-order-archive-manager' ); ?> </button>
                <button type="button" class="woam-presets" data-month="12"><?php esc_html_e( '1 year ago', 'woo-order-archive-manager' ); ?> </button>
                <button type="button" class="woam-presets" data-month="24"><?php esc_html_e( '2 years ago', 'woo-order-archive-manager' ); ?> </button>
            </div>
